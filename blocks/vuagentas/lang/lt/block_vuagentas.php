...
$string['descsekcijos'] = 'Mažiausias sekcijų (section) skaičius kurse.';

$string['labelforum'] = 'Forumų skaičius';
$string['descforum'] = "Mažiausias forumų (forum) skaičius kurse.";

$string['labelchat'] = 'Online diskusijų skaičius';
$string['descchat'] = 'Mažiausias online diskusijų (chat) skaičius kurse.';

$string['labelglossary'] = 'Žodynų skaičius';
$string['descglossary'] = 'Mažiausias terminų žodynų (glossary) skaičius kurse.';

$string['labelpage'] = 'Puslapių skaičius';
$string['descpage'] = 'WWW puslapių (page) skaičius sekcijoje.';

$string['labelvideo'] = 'Video skaičius';
$string['descvideo'] = 'Video medžiagos sekcijoje.';

$string['labelppt'] = 'Skaidrių skaičius';
$string['descppt'] = 'Skaidrių skaičius sekcijoje';

$string['labellink'] = 'Nuorodos į išorinius šaltinius';
$string['desclink'] = 'Nuorodų skaičius į išorinius šaltinius.';

$string['labeltestai'] = 'Testų skaičius';
$string['desctestai'] = 'Mažiausias testų (quiz) skaičius sekcijoje.';

$string['rating'] = 'Įvertinimas:';
$string['ratingnull'] = 'Nėra įvertinimo';
...
$string['noquiz_help'] = 'Testavimo įrankis labai svarbus kurse. Jo pagalba galima patikrinti studentų žinias, o parengus savikontrolės testą – žinias gali pasitikrinti patys studentai. Tai labai svarbu, kai šalia nėra dėstytojo, todėl savikontrolės testai yra rekomenduojami pabaigus kiekvieną temą.';
