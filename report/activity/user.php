...
add_to_log($course->id, 'course', 'report stats', "report/activity/user.php?id=$user->id&course=$course->id", $course->id);

$stractivityreport = get_string('activityreport');

$PAGE->set_pagelayout('admin');
$PAGE->set_url('/report/activity/user.php', array('id'=>$user->id, 'course'=>$course->id));
...
echo '<center><img src="'.$CFG->wwwroot.'/report/activity/graph.php?mode='.STATS_MODE_DETAILED.'&course='.$course->id.'&time='.$time.'&report='.STATS_REPORT_USER_VIEW.'&userid='.$user->id.'" alt="'.get_string('statisticsgraph').'" /></center>';
