...
class select_students_form extends moodleform{
    ...
    function definition() {
        ...
        $mform->addElement('date_selector', 'timestart', get_string('from', 'report_ataskaita4'));
        $mform->addElement('date_selector', 'timefinish', get_string('to', 'report_ataskaita4'));

        $students = $this->_customdata['students'];
        $mform->addElement('select', 'students_select', get_string('students', 'report_ataskaita4'), $students);
